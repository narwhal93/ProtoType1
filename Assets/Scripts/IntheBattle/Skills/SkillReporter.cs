...
public class SkillReporter : MonoBehaviour {
    ...
    void OnMouseDown()
    {
        if (m_skill == 1) BattleManager.Instance.m_SKillSt = BattleManager.SkillState.Skill1;
        if (m_skill == 2) BattleManager.Instance.m_SKillSt = BattleManager.SkillState.Skill2;
        if (m_skill == 3) BattleManager.Instance.m_SKillSt = BattleManager.SkillState.Skill3;
