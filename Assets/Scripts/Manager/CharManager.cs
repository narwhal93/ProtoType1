    ...
    void SetCharacterData()
    {
        ...
        for (int i = 0; i < DataManager.Instance.m_charNumPerTeam; i++)
        {
            if (DataManager.Instance.m_team1Data.ContainsKey(i) == true)
            {
                ...
                m_team2[i].m_level = DataManager.Instance.m_team1Data[i][1];
                ...
                m_team2[i].m_critChance = int.Parse(data_values[3]);
                m_team2[i].m_critDmg = int.Parse(data_values[4]);
                m_team2[i].m_ccChance = int.Parse(data_values[5]);
                m_team2[i].m_ccResist = int.Parse(data_values[6]);
                m_team2[i].m_coopChance = int.Parse(data_values[7]);
                m_team2[i].m_comboChance = int.Parse(data_values[8]);
